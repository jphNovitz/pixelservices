...
<header class="site-header flex relative overflow-hidden min-w-screen min-h-[calc(100vw*1.56)] md:min-h-[calc(100vw*0.56)]">
    ...
    <div class="min-w-full min-h-[calc(100vw*0.56)] absolute z-2 flex flex-col items-start  bg-slate-50 dark:bg-black bg-opacity-50 p-6 md:p-12">
        <!--        Site Title and menu button (on mobile)-->
        <div class="w-full flex flex-col md:flex-row w-full justify-start items-start">
        ...
        <div class="w-full min-h-full flex-1  my-0 p-12 flex flex-col justify-around items-center z-10">
